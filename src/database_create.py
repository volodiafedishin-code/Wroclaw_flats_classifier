...
polaczenie = sqlite3.connect(r"C:\Users\volod\ml_engineer\ml_basics\flat_project\data\uczelnie.db")
...
dane_uczelni = [
    # ============================================================
    # ВИЩІ НАВЧАЛЬНІ ЗАКЛАДИ ПУБЛІЧНІ (Державні)
    # ============================================================
    ('PWr - Politechnika Wrocławska',                         51.1107, 17.0618),
    ('UWr - Uniwersytet Wrocławski',                          51.1140, 17.0345),
    ('UEW - Uniwersytet Ekonomiczny we Wrocławiu',            51.0886, 17.0270),
    ('UPWr - Uniwersytet Przyrodniczy',                       51.1105, 17.0592),
    ('UMW - Uniwersytet Medyczny im. Piastów Śląskich',       51.1165, 17.0700),
    ('ASP - Akademia Sztuk Pięknych im. E. Gepperta',         51.1108, 17.0425),
    ('AWL - Akademia Wojsk Lądowych',                         51.1396, 17.0528),
    ('AWF - Akademia Wychowania Fizycznego',                  51.1171, 17.0981),
    ('AMUZ - Akademia Muzyczna im. K. Lipińskiego',           51.1145, 17.0224),
    ('AST - Akademia Sztuk Teatralnych im. L. Schillera',     51.1075, 17.0381),
    ('PWT - Papieski Wydział Teologiczny',                    51.1151, 17.0436),

    # ============================================================
    # ВИЩІ НАВЧАЛЬНІ ЗАКЛАДИ НЕПУБЛІЧНІ (Приватні)
    # ============================================================
    ('SWPS - Uniwersytet SWPS',                               51.1448, 17.0636),
    ('WSB - Uniwersytet WSB Merito',                          51.1154, 16.9942),
    ('DSW - Uniwersytet Dolnośląski',                         51.1119, 16.9912),
    ('WAB - Wrocławska Akademia Biznesu',                     51.0855, 17.0164),
    ('MWSLiT - Międzynarodowa WSL i Transportu',              51.1258, 17.0588),
    ('WSH - Wyższa Szkoła Humanistyczna',                     51.1272, 17.0525),
    ('WSP - Wyższa Szkoła Prawa',                             51.1178, 17.0189),
    ('Coventry University Wroclaw',                           51.0963, 17.0285),  # Centrum Południe
    ('WSZiA Edukacja - W. Szk. Zarządzania i Administracji',  51.0930, 17.0380),
    ('NWSM - Niepubliczna Wyższa Szkoła Medyczna',            51.1185, 17.0540),  # ul. Nowowiejska
    ('EWST - Ewangelikalna Wyższa Szkoła Teologiczna',        51.1145, 17.0405),  # Ostrów Tumski
    ('Apeiron - WSBPiI, Wydział Wrocław',                     51.0875, 17.0223),
    ('WSKZ - Wyższa Szkoła Kształcenia Zawodowego',           51.1100, 17.0200),
    ('Horyzont - Wrocławska WSI Stosowanej',                  51.1200, 17.0500),
    ('WSS - Wyższa Szkoła Sportu im. prof. R. Panfila',       51.1171, 17.0981),
    ('SWRA - Szk. Wyższa Rzemiosł Artystycznych',             51.1108, 17.0425),
    ('Varsovia - Uczelnia Biznesu i Nauk Stosowanych',        51.1100, 17.0400),
    ('WSIiZ Copernicus - W. Szk. Informatyki i Zarządzania',  51.1147, 17.0263),
    ...
    ('XVI LO - Liceum Kreatywności (ZS nr 8)',                51.1120, 17.0590),
    ('XVII LO im. Agnieszki Osieckiej',                       51.1017, 17.0163),
    ('XVIII LO (ZS nr 18 / Młodych Techników)',               51.1136, 17.0142),
    ...
    ('XXIV LO ze Sportowymi (ZSE-O, Drukarska)',              51.0901, 17.0160),  # Відкалібровано на Південь
    ('XXX LO - Liceum Sportowe (ZS nr 6, Nowodworska)',       51.1130, 16.9580),  # Відкалібровано на Новий Двір
    ...
    ('LO Olimp TEB Edukacja',                                 51.0935, 17.0520),
    ...
    ('Technikum nr 2 - Budowlane (ZSB)',                      51.0930, 16.9915),  # ul. Grabiszyńska
    ('Technikum nr 3 - (ZS nr 18, Młodych Techników)',        51.1136, 17.0142),
    ('Technikum nr 8 - Ekonomiczne (ZSE-O, Drukarska)',       51.0901, 17.0160),
    ('Technikum nr 9 - Gastronomiczno-Hotelarskie (ZS nr 2)', 51.0840, 17.0195),
    ('Technikum nr 10 - EZN (ul. Braniborska 57)',            51.1095, 17.0012),
    ('Technikum nr 11 - Elektroniczne (ZSE, Worcella)',       51.1078, 17.0082),
    ('Technikum nr 12 - Logistyczne (ul. Dawida 9-11)',       51.0964, 17.0385),  # Відкалібровано до вокзалу PKP
    ('Technikum nr 13 - ZSEA (ul. Worcella 3)',               51.1078, 17.0082),
    ('Technikum nr 14 - Integracyjne (ZS nr 6, Nowodworska)', 51.1130, 16.9580),
    ('Technikum nr 15 - Grafika/Design (Skwierzyńska)',       51.0991, 17.0188),
    ('Technikum nr 16 - Hotelarsko-Gastr. (ZS nr 3)',         51.0898, 17.0375),
    ('Technikum nr 18 - Samochodowe (ul. Ślężna 2-24)',       51.0945, 17.0280),  # Відкалібровано на південь
    ...
    # ============================================================
    # SZKOŁY POLICEALNE / INNE PONADPODSTAWOWE
    # ============================================================
